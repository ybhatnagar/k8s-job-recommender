...
.btn:active {
  -webkit-box-shadow: 0 2px 0 0 #0092d1 inset;
  box-shadow: 0 2px 0 0 #0092d1 inset;
}
...
.btn-success .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #1d5200 inset;
  box-shadow: 0 2px 0 0 #1d5200 inset;
}
...
.btn-outline-success .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #61b715 inset;
  box-shadow: 0 2px 0 0 #61b715 inset;
}
...
.btn-outline-warning .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #f8b5b4 inset;
  box-shadow: 0 2px 0 0 #f8b5b4 inset;
}
...
.alert .dropdown-toggle.btn:active {
  -webkit-box-shadow: 0 1px 0 0 #4e007a inset;
  box-shadow: 0 1px 0 0 #4e007a inset;
}
...
a.label.clickable.label-purple:active {
  -webkit-box-shadow: 0 1px 0 0 #9c57bc inset;
  box-shadow: 0 1px 0 0 #9c57bc inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-blue:active {
  -webkit-box-shadow: 0 1px 0 0 #004c8a inset;
  box-shadow: 0 1px 0 0 #004c8a inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
.nav .nav-link:hover, .nav .nav-link.active {
  -webkit-box-shadow: 0 -3px 0 #0077b8 inset;
...
.tooltip .tooltip-content.tooltip-top-right::before {
  ...
  border-top: 0.208333rem solid black;
...
.tooltip .tooltip-content.tooltip-bottom-right::before {
  ...
  content: "";
  border-left: 0.25rem solid black;
  border-bottom: 0.208333rem solid black;
  border-right: 0.25rem solid transparent;
...
.tooltip .tooltip-content.tooltip-right::before {
  ...
  border-right: 0.208333rem solid black;
...
.tooltip .tooltip-content.tooltip-left::before {
  ...
  content: "";
  border-top: 0.25rem solid black;
  border-left: 0.208333rem solid black;
  border-bottom: 0.25rem solid transparent;
...
.clr-checkbox-wrapper input[type=checkbox] + label::after {
  ...
  width: 0.3333335rem;
  border-left: 0.083333375rem solid white;
  border-bottom: 0.083333375rem solid white;
  top: 0.1666665rem;
  left: 0.16666675rem;
...
.clr-input:not([readonly]) {
  background: -webkit-gradient(linear, left top, left bottom, color-stop(95%, transparent), color-stop(95%, #0092d1)) no-repeat;
...
.clr-error .clr-input:not([readonly]) {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(95%, transparent), color-stop(95%, #c72100)) no-repeat;
  background: linear-gradient(to bottom, transparent 95%, #c72100 95%) no-repeat;
  background-size: 0% 100%;
  -webkit-transition: background-size 0.2s ease;
  transition: background-size 0.2s ease;
}
...
.clr-radio-wrapper input[type=radio]:checked + label::before {
  -webkit-box-shadow: inset 0 0 0 0.25rem #0077b8;
  box-shadow: inset 0 0 0 0.25rem #0077b8;
  border: none;
}
...
.clr-radio-wrapper input[type=radio]:focus:checked + label::before {
  outline: 0;
  -webkit-box-shadow: inset 0 0 0 0.25rem #0077b8, 0 0 2px 2px #69c0e2;
  box-shadow: inset 0 0 0 0.25rem #0077b8, 0 0 2px 2px #69c0e2;
}
...
.clr-error select[multiple]:focus {
  outline: 0;
  -webkit-box-shadow: 0 0 2px 2px #ff7b61;
  box-shadow: 0 0 2px 2px #ff7b61;
}
...
.pagination-list .pagination-current:focus, .pagination-list .pagination-current.clr-focus {
  background: none;
  border: 1px solid #45afd9;
  -webkit-box-shadow: 0 0 1px #45afd9;
  box-shadow: 0 0 1px #45afd9;
}
.pagination-list > * {
  padding: 0 0.1rem;
}
...
.datagrid-action-overflow::after {
  ...
  border-right: 0.2083333333rem solid white;
...
.tabs-vertical > .nav .nav-link.active, .tabs-vertical > .nav .nav-link:hover {
  -webkit-box-shadow: inset 3px 0 0 #0077b8;
  box-shadow: inset 3px 0 0 #0077b8;
}
...
.clr-wizard .clr-wizard-stepnav-item {
  display: block;
  -webkit-box-shadow: 0.166667rem 0 0 #ededed inset;
  box-shadow: 0.166667rem 0 0 #ededed inset;
  margin: 0 0 -1px 0;
  padding: 0.25rem 0;
...
.clr-accordion-header {
  color: #575757;
  border: 1px solid #cccccc;
  -webkit-box-shadow: inset 6px 0 0 #ededed;
