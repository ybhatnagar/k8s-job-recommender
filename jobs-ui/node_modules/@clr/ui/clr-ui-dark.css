...
.btn:active {
  -webkit-box-shadow: 0 2px 0 0 black inset;
...
.btn-primary .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #0065ad inset;
  box-shadow: 0 2px 0 0 #0065ad inset;
}
...
.btn-success .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #276b00 inset;
  box-shadow: 0 2px 0 0 #276b00 inset;
}
...
.btn-warning .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #c72100 inset;
  box-shadow: 0 2px 0 0 #c72100 inset;
}
...
.btn-inverse .btn:active {
  -webkit-box-shadow: 0 2px 0 0 #a8b5bd inset;
  box-shadow: 0 2px 0 0 #a8b5bd inset;
}
...
.close:focus {
  outline: 0;
  -webkit-box-shadow: 0 0 2px 2px #69c0e2;
  box-shadow: 0 0 2px 2px #69c0e2;
}
...
.card {
  -webkit-box-shadow: 0 3px 0 0 #0e161b;
  box-shadow: 0 3px 0 0 #0e161b;
  border-radius: 0.125rem;
...
a.label.clickable:active {
  -webkit-box-shadow: 0 1px 0 0 #6c7784 inset;
  box-shadow: 0 1px 0 0 #6c7784 inset;
...
a.label.clickable.label-purple:active {
  -webkit-box-shadow: 0 1px 0 0 #ae73c9 inset;
  box-shadow: 0 1px 0 0 #ae73c9 inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-blue:active {
  -webkit-box-shadow: 0 1px 0 0 #0077b8 inset;
  box-shadow: 0 1px 0 0 #0077b8 inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-orange:active {
  -webkit-box-shadow: 0 1px 0 0 #ff9c33 inset;
  box-shadow: 0 1px 0 0 #ff9c33 inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-light-blue:active {
  -webkit-box-shadow: 0 1px 0 0 #8bccdf inset;
...
a.label.label-warning {
  background: #816709;
  color: white;
  border: 1px solid #816709;
}
.label.label-danger,
a.label.label-danger {
  background: #862d31;
  color: white;
  border: 1px solid #862d31;
}
.label > .badge,
a.label > .badge {
...
.nav {
  ...
  -ms-flex-align: center;
  align-items: center;
  -webkit-box-shadow: 0 -1px 0 #495865 inset;
...
.nav .nav-link:hover, .nav .nav-link.active {
  -webkit-box-shadow: 0 -3px 0 #4aaed9 inset;
...
.tooltip .tooltip-content.tooltip-top-right::before {
  ...
  border-top: 0.208333rem solid white;
...
.tooltip .tooltip-content.tooltip-bottom-right::before {
  ...
  content: "";
  border-left: 0.25rem solid white;
  border-bottom: 0.208333rem solid white;
  border-right: 0.25rem solid transparent;
...
.tooltip .tooltip-content.tooltip-right::before {
  ...
  border-right: 0.208333rem solid white;
...
.tooltip .tooltip-content.tooltip-left::before {
  ...
  content: "";
  border-top: 0.25rem solid white;
  border-left: 0.208333rem solid white;
  border-bottom: 0.25rem solid transparent;
...
.clr-checkbox-wrapper input[type=checkbox] + label::after {
  ...
  width: 0.3333335rem;
  border-left: 0.083333375rem solid black;
  border-bottom: 0.083333375rem solid black;
  top: 0.1666665rem;
  left: 0.16666675rem;
...
.clr-input:not([readonly]):focus, .clr-input:not([readonly]).clr-focus {
  border-bottom: 1px solid #4aaed9;
...
.clr-error .clr-input:not([readonly]):focus, .clr-error .clr-input:not([readonly]).clr-focus {
  border-bottom: 1px solid #f55047;
  background-size: 100% 100%;
}
...
.clr-radio-wrapper input[type=radio]:checked + label::before {
  -webkit-box-shadow: inset 0 0 0 0.25rem #4aaed9;
  box-shadow: inset 0 0 0 0.25rem #4aaed9;
  border: none;
}
...
.clr-radio-wrapper input[type=radio]:focus:checked + label::before {
  outline: 0;
  -webkit-box-shadow: inset 0 0 0 0.25rem #4aaed9, 0 0 2px 2px #69c0e2;
  box-shadow: inset 0 0 0 0.25rem #4aaed9, 0 0 2px 2px #69c0e2;
}
...
.stack-view > :last-child .stack-block:last-of-type {
  border-bottom: none;
  -webkit-box-shadow: 0 1px 0 #566471;
  box-shadow: 0 1px 0 #566471;
}
...
.stack-view .stack-block-changed::before {
  ...
  width: 0;
  height: 0;
  border-top: 0.375rem solid #0065ad;
...
.stack-view .stack-block-expanded > .stack-block-content input[type=text], .stack-view .stack-block-expanded > .stack-block-content input[type=password], .stack-view .stack-block-expanded > .stack-block-content input[type=number], .stack-view .stack-block-expanded > .stack-block-content input[type=email], .stack-view .stack-block-expanded > .stack-block-content input[type=url], .stack-view .stack-block-expanded > .stack-block-content input[type=tel], .stack-view .stack-block-expanded > .stack-block-content input[type=date], .stack-view .stack-block-expanded > .stack-block-content input[type=time], .stack-view .stack-block-expanded > .stack-block-content input[type=datetime-local] {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(95%, transparent), color-stop(95%, #0077b8)) no-repeat;
  background: linear-gradient(to bottom, transparent 95%, #0077b8 95%) no-repeat;
  background-size: 0% 100%;
  -webkit-transition: background-size 0.2s ease;
  transition: background-size 0.2s ease;
}
...
.pagination-list .pagination-current:focus, .pagination-list .pagination-current.clr-focus {
  background: none;
  border: 1px solid #4aaed9;
  -webkit-box-shadow: 0 0 1px #4aaed9;
  box-shadow: 0 0 1px #4aaed9;
}
.pagination-list > * {
  padding: 0 0.1rem;
}
...
.datagrid-action-overflow::after {
  ...
  border-right: 0.2083333333rem solid #21333b;
...
.tabs-vertical > .nav .nav-link.active, .tabs-vertical > .nav .nav-link:hover {
  -webkit-box-shadow: inset 3px 0 0 #4aaed9;
  box-shadow: inset 3px 0 0 #4aaed9;
}
...
.clr-wizard .clr-wizard-stepnav-item {
  display: block;
  -webkit-box-shadow: 0.166667rem 0 0 #3b484e inset;
  box-shadow: 0.166667rem 0 0 #3b484e inset;
  margin: 0 0 -1px 0;
  padding: 0.25rem 0;
...
.clr-wizard .clr-wizard-stepnav-item.complete {
  -webkit-box-shadow: 0.166667rem 0 0 #61b715 inset;
  box-shadow: 0.166667rem 0 0 #61b715 inset;
  -webkit-transition: -webkit-box-shadow 0.2s ease-in;
  transition: -webkit-box-shadow 0.2s ease-in;
  transition: box-shadow 0.2s ease-in;
  transition: box-shadow 0.2s ease-in, -webkit-box-shadow 0.2s ease-in;
...
.signpost-content.top-left .popover-pointer:before, .signpost-content.top-middle .popover-pointer:before, .signpost-content.top-right .popover-pointer:before {
  border-top: 0.5rem solid #21333b;
  bottom: 2px;
}
...
.signpost-content.bottom-left .popover-pointer:before, .signpost-content.bottom-middle .popover-pointer:before, .signpost-content.bottom-right .popover-pointer:before {
  border-bottom: 0.5rem solid #21333b;
  top: 2px;
}
...
.signpost-content.left-top .popover-pointer:before, .signpost-content.left-middle .popover-pointer:before, .signpost-content.left-bottom .popover-pointer:before {
  border-left: 0.5rem solid #21333b;
}
...
.signpost-content.right-top .popover-pointer:before, .signpost-content.right-middle .popover-pointer:before, .signpost-content.right-bottom .popover-pointer:before {
  border-right: 0.5rem solid #21333b;
  left: 2px;
}
...
.droppable.draggable-match {
  border: 1px dashed #bd8fd6;
}
.droppable.draggable-over {
  border: 1px dashed #680094;
}
...
.clr-accordion-header {
  color: white;
  border: 1px solid #495865;
  -webkit-box-shadow: inset 6px 0 0 #2b4250;
  box-shadow: inset 6px 0 0 #2b4250;
  background: #1b2a32;
...
.clr-accordion-panel-complete .clr-accordion-header {
  -webkit-box-shadow: inset 6px 0 0 #61a220;
  box-shadow: inset 6px 0 0 #61a220;
}
...
.clr-accordion-panel-error .clr-accordion-header {
  border-color: #c72100;
  -webkit-box-shadow: inset 6px 0 0 #c72100;
  box-shadow: inset 6px 0 0 #c72100;
  border-bottom: 1px solid #c72100;
  background-color: #324f62;
}
...
.clr-accordion:not(.clr-stepper-forms) .clr-accordion-panel:last-child .clr-accordion-panel-open .clr-accordion-header {
  border-bottom-left-radius: 0;
  border-bottom-right-radius: 0;
  border-bottom: 0;
}
...
.clr-timeline-step:not(:last-of-type) .clr-timeline-step-body::before {
  ...
  background: #acbac3;
  height: 0.083333rem;
  width: calc( 100% - (1.5rem - 2 * 0.083333rem) + 0.5rem );
  -webkit-transform: translate(1.416667rem, -0.7916665rem);
...
.clr-timeline.clr-timeline-vertical .clr-timeline-step {
  ...
  margin-left: 0;
  position: relative;
  /* required for vertical line to get 100% height of step body it belongs to */
}
...
.clr-timeline.clr-timeline-vertical .clr-timeline-step:not(:last-of-type) .clr-timeline-step-body::before {
  ...
  -webkit-transform: translate(-1.2916665rem, 1.166667rem);
  transform: translate(-1.2916665rem, 1.166667rem);
}
