...
export var flipSides = function (position) {
    return tslib_1.__assign({}, position, { side: -1 * position.side });
};
...
export var flipAxis = function (position) {
    return tslib_1.__assign({}, position, { axis: position.axis === 0 ? 1 : 0 });
};
export var nudgeContent = function (position, forward) {
    var nextAlignment = position.content + (forward ? 0.5 : -0.5);
    if (nextAlignment < 0 || nextAlignment > 1) {
        return position;
    }
    else {
        return tslib_1.__assign({}, position, { content: nextAlignment });
    }
};
